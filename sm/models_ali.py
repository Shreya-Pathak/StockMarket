...
class Portfolio(models.Model):
    clid = models.ForeignKey(Client, models.DO_NOTHING, db_column='clid', primary_key=False)
...
class Buyorder(models.Model):
    ...
    portfolio=models.ForeignKey('Portfolio', models.DO_NOTHING, db_column='portfolio', blank=True, null=True,default=0)
    broker_exchange=models.ForeignKey('Registeredat', models.DO_NOTHING, db_column='broker', blank=True, null=True,default=0)
