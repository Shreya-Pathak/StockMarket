# Generated by Django 3.1.7 on 2021-03-13 11:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('latency', models.DecimalField(decimal_places=2, max_digits=15)),
            ],
        ),
        migrations.CreateModel(
            name='Client',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sid', models.OneToOneField(db_column='sid', on_delete=django.db.models.deletion.DO_NOTHING, to='market.stock')),
            ],
        ),
        migrations.CreateModel(
            name='OldOrder',
            fields=[
                ...
                ('reg_id', models.ForeignKey(db_column='reg_id', on_delete=django.db.models.deletion.DO_NOTHING, to='market.registeredat')),
                ('sid', models.ForeignKey(db_column='sid', on_delete=django.db.models.deletion.DO_NOTHING, to='market.stock')),
            ],
        ),
        migrations.CreateModel(
        ...
        migrations.CreateModel(
            name='BankAccount',
            fields=[
                ('account_number', models.IntegerField(db_column='account_number', primary_key=True, serialize=False)),
        ...
        migrations.AddConstraint(
            model_name='buysellorder',
            constraint=models.CheckConstraint(check=models.Q(completed_quantity__lte=django.db.models.expressions.F('initial_quantity')), name='valid_buy_state_check'),
        ),
    ]
