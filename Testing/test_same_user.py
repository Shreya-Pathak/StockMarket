...
class QuickStartUser(HttpUser):
    ...
    def signup(self):
        ...
        rep=self.client.post('signup',
                         {'email': [f'TestDupli@cs.com'], 'password': ['TestDupli'],'name':['TestDupli'],'address':['298D'],'telephone':['12888'] ,'client_signup':['Sign Up']},
    ...
    def login(self):
        ...
        rep=self.client.post('login',
                         {'username': 'TestDupli', 'password': 'TestDupli','client_login':'yes'},
                         headers={'X-CSRFToken': csrftoken}, allow_redirects=True)
        # print(dir(rep))
        # print_msgs(rep)
